        ...
        >
            <Typography>
                ...
                <p>
                    ...
                    Let me guess, if you are using a{" "}
                    <span className="underline">large screen</span> to browse
                    this page, you may be able to see my{" "}
                ...
                <p>
                    Let's talk about the history of my nickname. You may have
                    noticed a detail about my avatar. I like{" "}
                    <span className="text-emerald-600 dark:text-emerald-400">
                        green
                    </span>{" "}
                ...
                <ul>
                    ...
                    <li>
                        <span className="italic">Very</span> poor at
                        mathematics. One of the regrets in life is not being
                        able to understand mathematics. (Ela's physics is better
                        than math!)
                    </li>
                </ul>
                ...
                <ul>
                    ...
                    <li>
                        Usually very gentle, but sometimes it becomes very
                        irritable.
                    </li>
                    <li>
                        Flight speed is not fast, unless it is a critical
                        moment.
                    </li>
                    <li>
                        Be very frank with friends. It's difficult for me to
                        pretend emotions.
                    </li>
                </ul>
                <h2>About My Cutie Mark</h2>
                <p>
                    The subject of my cutie mark is the moon. The moon 🌙
                    represents guardianship, and star ⭐ means companionship.
                </p>
                ...
                <ul>
                    <li>
                        ...
                        . Hundreds of hours of gameplay. I've wasted most of my
                        life on this game.
                    </li>
                    <li>
                        Game series{" "}
                        ...
                        . Maybe I was a great swordsman to save the princess
                        Zelda.
                    </li>
                    <li>
                        Animation{" "}
                    ...
                    <li>
                        ...
                        . They all make me enjoyable! And my favorite TEC level
                        is Metamorphosis.
                    </li>
                </ul>
                <h2>Contact Me</h2>
